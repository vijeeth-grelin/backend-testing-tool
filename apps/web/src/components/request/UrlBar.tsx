  ...
  return (
    <div className="flex-1 relative group">
      <input
        ...
        className="w-full bg-muted/30 border rounded-md px-4 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary transition-all group-hover:bg-muted/50"
      />
      {value.includes('{{') && (
